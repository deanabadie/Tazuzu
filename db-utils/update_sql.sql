...
CREATE TABLE `tazuzu`.`user_trans` (
  ...
  CONSTRAINT `fk_user_trans_tbl_user_id`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_user_trans_tbl_last_edited_by`
...
ALTER TABLE `tazuzu`.`user` 
DROP FOREIGN KEY `fk_user_tbl_last_edited_by`;
ALTER TABLE `tazuzu`.`user` 
DROP INDEX `fk_user_tbl_last_edited_by_idx` ;

ALTER TABLE `tazuzu`.`user` 
DROP COLUMN `user_name`,
DROP COLUMN `last_edit_by`,
DROP INDEX `UK_lqjrcobrh9jc8wpcar64q1bfh` ;